...
function Board(row, col){
    ...
    this.render = function() {
        //&nbsp = Cuando queremos que dos palabras no se separen al ajustar el texto al tamaño de la ventana, por ejemplo las dos palabras que forman una marca.
        var spaces = "";
        //Creamos el atributo data-row y data-col.
        for (i = 1; i <= row; i++) {
            for (j = 1; j <= col; j++) {
...
function newGame() {
    // creamos la tabla con la cantidad de casillas.
    board = new Board(7,7);
    board.render();
